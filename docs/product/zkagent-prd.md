# zkagent — PRD v1.40 — 2026-09-02, owner-approved
...
**Version history**: §15. This revision (v1.40 — 2026-09-02, owner-approved) records two further
...
oldest-first eviction unchanged; 200 entries would be an unusable scroll. The code change itself is
**NOT yet applied** — it is a one-constant change queued behind D58 step 3, currently in flight, to
avoid two agents building the same module at once; until it lands the shipped constant remains
`200`. **Q43** opens a UI/UX enhancement, DEFERRED under D57's freeze and not designed here:
