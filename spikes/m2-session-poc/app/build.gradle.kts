...
android {
    ...
    defaultConfig {
        applicationId = "com.zkagent.m2sessionpoc"
        // minSdk bumped from m2-scan's 23: this spike calls
        // KeyGenParameterSpec.Builder#setIsStrongBoxBacked (API 28) and
        // BiometricPrompt.CryptoObject per-use auth via
        // setUserAuthenticationParameters(0, ...) (API 30). Throwaway spike,
        // single real target device (Pixel 6a, Android 14+) — no need to
        // support older API levels here.
        minSdk = 30
        targetSdk = 36
        versionCode = 1
...
dependencies {
    ...
    implementation(libs.androidx.biometric) // BiometricPrompt for §6.2 item 2/12
}
